...
abstract class AnimeRepositoryInterface {
  Future<Either<Failure, List<AnimeEntity>>> getTopAnime(int page, {int? limit});
  Future<Either<Failure, List<AnimeEntity>>> searchAnime(String query, int page, {int? genreId});
